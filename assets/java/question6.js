...
/*********************/
 var npoup16 = document.querySelector('.poup16');
 var nicon =  document.querySelector(' .list .nicon');
  var close16 = document.querySelector('.close16');

console.log(nicon);
  nicon.onclick = function(){
    npoup16.style.display = 'block';
